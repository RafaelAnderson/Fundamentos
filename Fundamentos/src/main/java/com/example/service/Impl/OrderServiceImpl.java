...
public class OrderServiceImpl implements OrderService {
    ...
    public Order createOrder(Order order) {
        ...
        order.setStatus(statusRepository.getOne((long) 1));
    ...
    public Order updateOrderStatus(Long id) {
        ...
        orderDB.setStatus(statusRepository.getOne((long) 2));
    ...
    @Transactional(readOnly = true)
    @Override
    public List<Order> getOrdersByRestaurantAndStatus(Long restaurantId, Long statusId) {
        return orderRepository.findOrdersByRestaurantAndStatus(restaurantId, statusId);
    }
